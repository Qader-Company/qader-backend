...
return new class extends Migration
{
    public function up(): void
    {
        ...
        Schema::create('talent_work_preferences', function (Blueprint $table) {
            $table->id();
            $table->foreignId('talent_id')->unique()->constrained()->cascadeOnDelete();
        ...
        Schema::create('talent_documents', function (Blueprint $table) {
            ...
            $table->timestamps();
            $table->index(['talent_id', 'type', 'is_current']);
        });
    }
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('talent_work_preferences');
